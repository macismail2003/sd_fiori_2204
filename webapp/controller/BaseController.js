sap.ui.define([
	...
	return Controller.extend("com.seaco.sd_fiori.controller.BaseController", {
		/**
		...
		addMessages: function (sTarget, sMessage, sLongText, oMessageProcessor, index) {
			...
			oMessageManager.addMessages(
				new Message({
					...
					type: sTarget, //MessageType.Error,
					target: sTarget,
